...
export declare type DependencyGraphMap<MetaType> = Map<
  string,
  DependencyInterface<MetaType>
>
...
export declare interface DependencyGraphInterface<MetaType> {
  ...
  ): DependencyGraphMap<MetaType>

  removeDependency(
    dependencyOrKey: DependencyInterface<MetaType> | string
  ): boolean
}